...
- CHANGELOG.md is managed by release automation (release-it with conventional-changelog plugin)
- Do not add commitlint to CI workflows; version calculation uses Conventional Commits but non-conventional commits must not block CI
